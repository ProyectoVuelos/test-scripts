...
def organize_flight_data(data):
    ...
    for flight in data:
        ...
        current_flight_data = organized_data.setdefault(fr24_id, {"fr24_id": fr24_id, "historical": []})
        ...
        flight_copy.pop('fr24_id', None) # Use None as default to prevent KeyError if already popped
...
if __name__ == "__main__":
    ...
    with open("data/positions/aggregate_positions_202507021645_organized.json", "w") as f:
